  ...
  return (
    <View style={styles.container}>
      ...
      <MapView
        ...
        initialRegion={{ latitude: 46.8, longitude: 8.2, latitudeDelta: 40, longitudeDelta: 60 }}
        mapType="standard"
      >
        {spots.map((spot) => (
          <Marker
...
const styles = StyleSheet.create({
  ...
  header: { paddingTop: 60, paddingBottom: 14, paddingHorizontal: 20, backgroundColor: '#000' },
  headerTitle: { color: 'white', fontSize: 26, fontWeight: 'bold' },
  headerSub: { color: '#666', fontSize: 13, marginTop: 2 },
  map: { flex: 1 },
  callout: { backgroundColor: '#111', borderRadius: 14, overflow: 'hidden', width: 200, borderWidth: 1, borderColor: '#333' },
  calloutPhoto: { width: '100%', height: 120 },
  calloutPhotoPlaceholder: { width: '100%', height: 120, backgroundColor: '#1a1a1a', justifyContent: 'center', alignItems: 'center' },
  calloutInfo: { padding: 10, alignItems: 'flex-start' },
  calloutMake: { color: '#aaa', fontSize: 11 },
  calloutModel: { color: 'white', fontSize: 17, fontWeight: 'bold', marginBottom: 6 },
  ...
  emptyOverlay: { position: 'absolute', bottom: 40, left: 20, right: 20, backgroundColor: 'rgba(0,0,0,0.85)', borderRadius: 16, padding: 20, alignItems: 'center', borderWidth: 1, borderColor: '#222' },
